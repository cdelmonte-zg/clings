// function_pointers1.c - Solution
//
// The fix: array_map() must store the result of fn() back into the array.
// The buggy version called fn(arr[i]) but discarded the return value.
